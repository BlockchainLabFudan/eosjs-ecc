...
/**
  ...
  @param {string} [pubkey_prefix = 'GOC']
*/
function PublicKey(Q, pubkey_prefix = 'GOC') {
    if(typeof Q === 'string') {
    ...
    */
    function toString(pubkey_prefix = 'GOC') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'GOC']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'GOC') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'GOC') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'GOC') {
